...
Consumer setup requires `PlainConceptsPlatform/opencode-onboard`. Loop workers invoke its skills and commands. Verify they are available before compiling workflows.
